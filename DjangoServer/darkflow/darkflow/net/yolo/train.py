...
def loss(self, net_out):
    ...
    # flatten 'em all
    probs = tf.compat.v1.constrib.slim.flatten(_probs)
    proid = tf.compat.v1.constrib.slim.flatten(proid)
    confs = tf.compat.v1.constrib.slim.flatten(confs)
    conid = tf.compat.v1.constrib.slim.flatten(conid)
    coord = tf.compat.v1.constrib.slim.flatten(_coord)
    cooid = tf.compat.v1.constrib.slim.flatten(cooid)
